...
#md # And you can produce a back and forth rocking motion if you use `sin(nfn * 2π)`:
...
IMAGEFOLDER = "/assets/images/slackmojif"                                                      #src
Literate.markdown("src/source/slackmojif.jl", ".", name="src/pages/2019-06-23-slackmojif",     #src
